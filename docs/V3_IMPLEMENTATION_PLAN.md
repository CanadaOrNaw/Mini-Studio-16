...
| M7 full duplex/expansion | Removable Rev-A Audio Cap with ESP32-WROOM-32E A2DP, PCM1808 line ADC, Cardputer bridge, shared bounded resampling/CRC core, pair/monitor CLI, cap firmware profile, BOM with CA/US/EU sourcing, code-defined PCB review source, deterministic snap-shell STLs and first-article checklist | Protocol/sequence/CRC/ring/resampling host tests; all three firmware profiles compile in CI; CAD topology and PCB artifacts are reproducible | Physical cap footprint sign-off, power/audio/RF/latency/thermal/fit soak; onboard ES8311 full-duplex experiment remains optional |
